...
pub(crate) async fn draw_character_select_menu() -> MainMenuSelection {
    ...
    let mut characters = {
        ...
        get_available_characters(&game_params.characters_path).await.unwrap()
    };
            ...
            if let Some(i) = selected_character_index {
                ...
                widgets::Window::new(hash!(), position, size)
                    ...
                    .ui(&mut *root_ui(), |ui| {
                        ...
                        let size = vec2(size.x, size.y - 45.0 - GuiSkins::ELEMENT_MARGIN - GuiSkins::BUTTON_HEIGHT) - margins;
