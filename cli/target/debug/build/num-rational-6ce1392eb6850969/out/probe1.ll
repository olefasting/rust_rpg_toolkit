...
@alloc9 = private unnamed_addr constant <{ [75 x i8] }> <{ [75 x i8] c"/rustc/5eacec9ec7e112a0de1011519a57c45586d58414/library/core/src/fmt/mod.rs" }>, align 1
...
; Function Attrs: inlinehint nonlazybind uwtable
define internal void @_ZN4core3fmt9Arguments6new_v117hba2b95985afea972E(%"std::fmt::Arguments"* noalias nocapture sret(%"std::fmt::Arguments") dereferenceable(48) %0, [0 x { [0 x i8]*, i64 }]* nonnull align 8 %pieces.0, i64 %pieces.1, [0 x { i8*, i64* }]* nonnull align 8 %args.0, i64 %args.1) unnamed_addr #0 {
start:
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17hd695e3b1d0dd4ef4E([0 x i8]* nonnull align 1 bitcast (<{ [12 x i8] }>* @alloc8 to [0 x i8]*), i64 12, %"std::panic::Location"* align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc10 to %"std::panic::Location"*))
  unreachable
}
...
; call core::ptr::drop_in_place<alloc::raw_vec::RawVec<u8>>
  call void @"_ZN4core3ptr53drop_in_place$LT$alloc..raw_vec..RawVec$LT$u8$GT$$GT$17ha900a99496769a87E"({ i8*, i64 }* %2) #6
  br label %bb1
...
; call core::num::nonzero::NonZeroUsize::new_unchecked
  %_4 = call i64 @_ZN4core3num7nonzero12NonZeroUsize13new_unchecked17h4b5acc5ddad64800E(i64 %align), !range !4
  br label %bb1
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117hba2b95985afea972E(%"std::fmt::Arguments"* noalias nocapture sret(%"std::fmt::Arguments") dereferenceable(48) %_3, [0 x { [0 x i8]*, i64 }]* nonnull align 8 bitcast (<{ i8*, [8 x i8] }>* @alloc7 to [0 x { [0 x i8]*, i64 }]*), i64 1, [0 x { i8*, i64* }]* nonnull align 8 %_15.0, i64 1)
  br label %bb2
...
declare void @_ZN4core9panicking5panic17hd695e3b1d0dd4ef4E([0 x i8]* nonnull align 1, i64, %"std::panic::Location"* align 8 dereferenceable(24)) unnamed_addr #2
